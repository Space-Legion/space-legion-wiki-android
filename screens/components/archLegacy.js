  ...
  return (
    <ScrollView style={styles.container}>
      <View>
        ...
        <Text></Text>
        <Text style={styles.guide}>
          4 # cfdisk /dev/sda (your hardisk name)
        </Text>
        <Text></Text>
        <Text></Text>
        ...
        <Text></Text>
        <Text style={styles.guide}>
          BIOS System partition (/dev/sda1) with 128M (512M might be a lit bit
          too much or its your choice )size, ext4 formatted.
        </Text>
        <Text></Text>
        <Text style={styles.guide}>
        ...
        <Text></Text>
        <Text style={styles.guide}>
          ={'>'} Select new type the partition size in 128MB and press enter
          key, make it bootable by clicking 'B'
        </Text>
        <Text></Text>
        <Text style={styles.guide}>
        ...
        <Text></Text>
        <Text style={styles.guide}>
          5 # mkfs.ext4 /dev/sda1 (creates a file system for bios System
          partition)
        </Text>
        <Text></Text>
        <Text style={styles.guide}>
          6 # mkfs.ext4 /dev/sda2 (create the EXT4 file system for the root
          partition)
        </Text>
        <Text style={styles.guide}>================================</Text>
        <Text></Text>
        ...
        <Text></Text>
        <Text style={styles.guide}>
          7 # mount /dev/sda2 /mnt (In order to install Arch Linux, the /(root)
          partition must be mounted to /mnt directory mount point){' '}
        </Text>
        <Text></Text>
        <Text style={styles.guide}>
          8 # mkdir -p /mnt/boot/efi (making directory for EFI installation){' '}
        </Text>
        <Text></Text>
        <Text style={styles.guide}>
          9 # mount /dev/sda1 /mnt/boot/efi (mounting efi for installation){' '}
        </Text>
        <Text></Text>
        <Text style={styles.guide}>10 # pacman -Syy (to sync) </Text>
        <Text></Text>
        <Text style={styles.guide}>
          11 # pacstrap /mnt base base-devel linux linux-firmware vim (installs
          base system, base development tools, linux kernel, firmware, cli
          editor){' '}
        </Text>
        <Text></Text>
        <Text style={styles.guide}>
          12 # genfstab -U /mnt {'>>'} /mnt/etc/fstab (generates fstab file for
        ...
        <Text></Text>
        <Text style={styles.guide}>
          13 # arch-chroot /mnt (chroots into /mnt the system path)
        </Text>
        <Text></Text>
        <Text style={styles.guide}>
          14 # ln -sf /usr/share/zoneinfo/Europe/Berlin /etc/localtime
          (configure your region and city, This is an example){' '}
        </Text>
        <Text></Text>
        <Text style={styles.guide}>
          15 # hwclock --systohc (configure the hardware clock to use UTC, the
          hardware clock is usually set to the local time){' '}
        </Text>
        <Text></Text>
        <Text style={styles.guide}>
          16 # vim /etc/locale.gen (Configuring your system Language. Choose and
          uncomment your preferred encoding languages from /etc/locale.gen){' '}
        </Text>
        <Text>In this scenario- "en_US.UTF-8 UTF-8", "en_US ISO-8859-1" </Text>
        <Text></Text>
        <Text style={styles.guide}>
          17 # locale-gen (Generates your system language layout){' '}
        </Text>
        <Text></Text>
        <Text style={styles.guide}>
          18 # echo LANG=en_US.UTF-8 {'>>'} /etc/locale.conf (This assigns
          english as default language){' '}
        </Text>
        <Text></Text>
        <Text style={styles.guide}>
          19 # echo Arch Linux {'>>'} /etc/hostname (type a name for your host,
          eg: Archlinux){' '}
        </Text>
        <Text></Text>
        <Text style={styles.guide}>
          20 # passwd (create a password for root user)
        </Text>
        <Text></Text>
        <Text style={styles.guide}>
          21 # pacman -S grub efibootmgr networkmanager (installs grub,
          efibootmgr for uefi system and network manager){' '}
        </Text>
        <Text></Text>
        <Text style={styles.guide}>
          22 # grub-install --target=x86_64-efi --efi-directory=/boot/efi
          --bootloader-id=GRUB (installs grub)
        </Text>
        <Text></Text>
        <Text style={styles.guide}>
          23 # grub-mkconfig -o /boot/grub/grub.cfg (creating GRUB configuration
          file){' '}
        </Text>
        <Text></Text>
        <Text style={styles.guide}>
          24 # systemctl enable NetworkManager (enabling it from boot itself){' '}
        </Text>
        <Text></Text>
        <Text style={styles.guide}>
          25 # useradd -mG wheel "username" (creates a user account with sudo
          permissions){' '}
        </Text>
        <Text></Text>
        <Text style={styles.guide}>
          26 # passwd "username" (create a password for user account){' '}
        </Text>
        <Text></Text>
        <Text style={styles.guide}>
          27 # EDITOR=nano visudo (adding user account to sudoers group){' '}
        </Text>
        <Text></Text>
        <Text style={styles.guide}>
        ...
        <Text></Text>
        <Text style={styles.guide}>
          28 # exit (exiting chroot environment){' '}
        </Text>
        <Text></Text>
        <Text style={styles.guide}>
          29 # umount -R /mnt (This will unmount drives){' '}
        </Text>
        <Text></Text>
        <Text style={styles.guide}>30 # reboot</Text>
        <Text></Text>
        <Text style={styles.guide}>
        ...
        <Text style={styles.guide}>=======================</Text>
        <Text></Text>
        <Text style={styles.guide}>24 # pacman -S xorg (display server) </Text>
        <Text></Text>
        <Text style={styles.guide}>Installing Graphics drivers </Text>
        <Text style={styles.guide}>===========================</Text>
        <Text></Text>
        <Text style={styles.guide}>
        ...
        <Text></Text>
        <Text style={styles.guide}>
          (gvfs {'&'} gvfs-mtp- Mounting support for android devices, terminal
          for linux terminal emulator, screenshot for there purpose, blueberry
        ...
        <Text style={styles.guide}>
          ...
          xed- text editor, chromium {'&'} firefox- browsers,gvfs {'&'}{' '}
          gvfs-mtp- Mounting support for android devices){' '}
        </Text>
        <Text></Text>
        <Text style={styles.guide}>25 # reboot </Text>
        <Text></Text>
        <Text style={styles.guide}>
        ...
        <Text></Text>
        <Text
          style={{color: '#48FC01', fontSize: 20, fontWeight: 'bold'}}
          onPress={() =>
            Linking.openURL('https://www.archlinux.org/mirrorlist/all/')
          }>
          Arch Linux Mirrors
        </Text>
        <Text></Text>
        ...
        <Text style={styles.guide}>
          ...
          of greeter-session) (from yay), arc-gtk-theme papirus-icon-theme
          (pacman){' '}
        </Text>
        <Text></Text>
        <Text
