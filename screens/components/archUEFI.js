  ...
  return (
    <ScrollView style={styles.container}>
      <View>
        ...
        <Text></Text>
        <Text style={styles.guide}>
          ={'>'} Select new type the partition size in MB (512M) and press enter
          key, select Type from the bottom menu and choose EFI
        </Text>
        <Text></Text>
        <Text style={styles.guide}>
        ...
        <Text></Text>
        <Text style={styles.guide}>
          5 # mkfs.fat -F32 /dev/sda1 (creates a FAT32 file system for EFI
          System partition)
        </Text>
        <Text></Text>
        <Text style={styles.guide}>
